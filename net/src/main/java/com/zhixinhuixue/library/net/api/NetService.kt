...
interface NetService {
    ...
    suspend fun getBanner(): BaseNetEntity<BannerEntity>
    ...
    suspend fun getProjectTreeTitle(): BaseNetEntity<ArrayList<ProjectTreeEntity>>
    ...
    suspend fun getWxArticleChapter(): BaseNetEntity<ArrayList<ProjectTreeEntity>>
    ...
    suspend fun getHotSearch(): BaseNetEntity<ArrayList<SearchEntity>>
    ...
    suspend fun getKnowledgeTree(): BaseNetEntity<ArrayList<KnowledgeTreeEntity>>
    ...
    suspend fun getArticleNavigation(): BaseNetEntity<ArrayList<NavigationEntity>>
    ...
    suspend fun getCollectList(@Path("page") pageNo: Int): BaseNetEntity<ListNetEntity<ArrayList<CollectToolEntity>>>

    /**
     * 获取收藏网址数据
     */
    @GET(NetUrl.COLLECT_USER_TOOL_URL)
    suspend fun getCollectUserTool(): BaseNetEntity<ArrayList<CollectToolEntity>>
    ...
    suspend fun getCoinRank(@Path("page") page: Int): BaseNetEntity<ListNetEntity<ArrayList<IntegralEntity>>>

    /**
     * 获取积分历史
     */
    @GET(NetUrl.HISTORY_COIN_LIST_PAGE_URL)
    suspend fun getHistoryIntegral(@Path("page") page: Int): BaseNetEntity<ListNetEntity<ArrayList<IntegralEntity>>>
    ...
    suspend fun getTodoList(@Path("page") page: Int): BaseNetEntity<ListNetEntity<ArrayList<TodoEntity>>>
